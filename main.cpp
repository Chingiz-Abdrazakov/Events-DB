...
string ParseEvent(istream& is) {
    ...
    size_t pos = ev.find_first_not_of(' ');
    return ev.substr(pos, string::npos);
}
...
void TestAll() {
    ...
    tr.RunTest(TestInsertionOrder, "Test checking insertion order");
    tr.RunTest(TestsMyCustom, "My tests");
    tr.RunTest(TestDatabase, "Database test from GitHub");
